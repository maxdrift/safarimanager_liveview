...
#   password: "postgres",
#   hostname: "localhost",
#   database: "safarimanager_dev",
#   show_sensitive_data_on_connection_error: true,
#   pool_size: 10

config :safarimanager, SM.Repo, database: "safarimanager.db"
...
config :safarimanager, SMWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "9yJWSy9DRKoxv5bIRPpKmwjc7CW1BbrGC/N8uFBT/xCIDpBhbeeoMhkV29WcO5AJ",
  watchers: [
    npx: [
      "tailwindcss",
      "--input=css/app.css",
