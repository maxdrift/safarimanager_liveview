  ...
  def layout(assigns) do
    ...
    <div class="flex grow h-full">
      ...
      <div class="grow overflow-y-auto">
        <div class="md:hidden sticky flex items-center justify-between h-14 px-4 top-0 left-0 z-[500] bg-base-100 border-b border-base-300 text-base-content">
          <div class="pt-1 text-xl text-base-content/70 hover:text-base-content focus:text-base-content">
            <button
          ...
          <div class="text-base-content/60 hover:text-base-content focus:text-base-content">
            <%= if @topbar_action do %>
