defmodule SMWeb.Components.UploadDropArea do
  ...
  def upload_drop_area(assigns) do
    ...
    >
      <label class="w-full flex flex-col items-center px-4 py-6 rounded-box border-2 border-dashed border-base-300 bg-base-100/70 text-base-content tracking-wide uppercase cursor-pointer transition-colors hover:border-primary hover:bg-base-100 hover:text-primary">
