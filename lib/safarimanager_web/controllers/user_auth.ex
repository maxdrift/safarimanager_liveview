defmodule SMWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    _result =
      if live_socket_id = get_session(conn, :live_socket_id) do
        SMWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
      end
  ...
  the current_user:
      ...
      defmodule SMWeb.PageLive do
        use SMWeb, :live_view

        on_mount {SMWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SMWeb.UserAuth, :ensure_authenticated}] do
