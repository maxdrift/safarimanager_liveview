defmodule SM.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule SMWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: SM.PromEx
  ...
  use PromEx, otp_app: :safarimanager
  ...
  def dashboards do
    [
      ...
      # {:safarimanager, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
